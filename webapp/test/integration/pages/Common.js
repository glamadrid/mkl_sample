sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/appcelima/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.sap.appcelima.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/appcelima/localService/mockserver"], function (mockserver) {
