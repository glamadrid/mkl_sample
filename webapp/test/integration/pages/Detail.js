							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("GoMaster");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.GoMaster === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "<CabeceraDetaleNavPlural> (" + iNumberOfItems + ")"}),
									success : function () {
